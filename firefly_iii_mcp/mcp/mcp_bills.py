...
def register_bills_tools(mcp: FastMCP):
    """Register `bills` domain dynamic tools."""

    @mcp.tool(tags={"bills"})
    async def bills_operations(
        action: str = Field(
            description="Action to perform. One of: 'delete_bill', 'get_bill', 'list_attachment_by_bill', 'list_bill', 'list_rule_by_bill', 'list_transaction_by_bill', 'store_bill', 'update_bill'."
        ),
